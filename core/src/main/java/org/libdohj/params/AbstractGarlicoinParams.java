...
/**
 * Common parameters for Garlicoin networks.
 */
public abstract class AbstractGarlicoinParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the GRLC denomination. */
    public static final MonetaryFormat GRLC;
    /** Standard format for the mGRLC denomination. */
    public static final MonetaryFormat MGRLC;
    /** Standard format for the Liteoshi denomination. */
    public static final MonetaryFormat GARLOSHI;

    public static final int GRLC_TARGET_TIMESPAN = (int) (60 * 60); // 1 hour
    public static final int GRLC_TARGET_SPACING = (int) (40); // 40 seconds
    public static final int GRLC_INTERVAL = GRLC_TARGET_TIMESPAN / GRLC_TARGET_SPACING;

    /**
     * The maximum number of coins to be generated
     */
    public static final long MAX_GARLICOINS = 69000000; // TODO: Needs to be 840000000

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_GARLICOIN_MONEY = COIN.multiply(MAX_GARLICOINS);

    /** Currency code for base 1 Garlicoin. */
    public static final String CODE_GRLC = "GRLC";
    /** Currency code for base 1/1,000 Garlicoin. */
    public static final String CODE_MGRLC = "mGRLC";
    /** Currency code for base 1/100,000,000 Garlicoin. */
    public static final String CODE_GARLOSHI = "Garloshi";

    static {
        GRLC = MonetaryFormat.BTC.noCode()
            .code(0, CODE_GRLC)
            .code(3, CODE_MGRLC)
            .code(7, CODE_GARLOSHI);
        MGRLC = GRLC.shift(3).minDecimals(2).optionalDecimals(2);
        GARLOSHI = GRLC.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_GRLC_MAINNET = "org.garlicoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_GRLC_TESTNET = "org.garlicoin.test";
    /** The string returned by getId() for regtest. */
    public static final String ID_GRLC_REGTEST = "regtest";

    public static final int GARLICOIN_PROTOCOL_VERSION_MINIMUM = 70002;
    public static final int GARLICOIN_PROTOCOL_VERSION_CURRENT = 70003;

    private static final Coin BASE_SUBSIDY = COIN.multiply(50);

    protected Logger log = LoggerFactory.getLogger(AbstractGarlicoinParams.class);

    public AbstractGarlicoinParams() {
        super();
        interval = GRLC_INTERVAL;
        targetTimespan = GRLC_TARGET_TIMESPAN;
     ...
     * the weird cases for Garlicoin such as testnet blocks which can be maximum
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return GARLICOIN_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return GARLICOIN_PROTOCOL_VERSION_MINIMUM;
        }
    }
