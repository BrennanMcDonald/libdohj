...
/**
 * Parameters for the testnet, a separate public instance of Garlicoin that has
 * relaxed rules suitable for development and testing of applications and new
 * Garlicoin versions.
 */
public class GarlicoinTestNet3Params extends AbstractGarlicoinParams {
    public static final int TESTNET_MAJORITY_WINDOW = 100;
    public static final int TESTNET_MAJORITY_REJECT_BLOCK_OUTDATED = 75;
    public static final int TESTNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 51;

    public GarlicoinTestNet3Params() {
        super();
        id = ID_GRLC_TESTNET;
    ...
    private static GarlicoinTestNet3Params instance;
    public static synchronized GarlicoinTestNet3Params get() {
        if (instance == null) {
            instance = new GarlicoinTestNet3Params();
        }
        return instance;
    }
