 ...
 */
public class GarlicoinRegTestParams extends GarlicoinTestNet3Params {
    ...
    private static GarlicoinRegTestParams instance;

    public static synchronized GarlicoinRegTestParams get() {
        if (instance == null) {
            instance = new GarlicoinRegTestParams();
        }
        return instance;
    }
